...
def main():
    ...
    funcao_service = FuncaoService(funcoes)
    evento_service = EventoService(eventos, funcoes)
    ...
    if resultado == "pessoa":
        pessoa_storage.salvar(pessoas)

    if resultado == "funcao":
        funcao_storage.salvar(funcoes)

    if resultado == "evento":
        evento_storage.salvar(eventos)
